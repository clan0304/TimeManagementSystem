      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {systems.map((system) => (
            <div
              key={system.key}
              className="group relative p-6 rounded-2xl bg-linear-to-b from-zinc-900 to-zinc-900/50 border border-zinc-800 hover:border-[#22D3EE]/50 transition-all duration-300"
            >
